...
namespace Greewf.BaseLibrary.FastQueryBuilder.Infrastructure.Implementation.Expressions
{
    ...
    internal class FilterDescriptorCollectionExpressionBuilder : FilterExpressionBuilder
    {
        ...
        public FilterDescriptorCollectionExpressionBuilder(
            ParameterExpression parameterExpression, IEnumerable<IFilterDescriptor> filterDescriptors, FilterCompositionLogicalOperator logicalOperator)//EDITED By Moravej

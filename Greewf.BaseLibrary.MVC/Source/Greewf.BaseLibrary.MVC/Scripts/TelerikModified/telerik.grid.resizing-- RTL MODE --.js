(function ($) {
    var $t = $.telerik;
    var isRtl = true; //added by moravej. TODO : find a way if you think you will use it in combination
    ...
    $t.resizing.initialize = function (grid) {
        ...
        function positionResizeHandle($th) {
            ...
            $('.t-resize-handle', grid.element).each(function () {
                ...
                $(this).css(isRtl ? 'right' : 'left', left - indicatorWidth);
            });
        ...
        function drag(e) {
            ...
            var width = columnWidth + (isRtl ? columnStart - e.pageX : e.pageX - columnStart);
            ...
            if (width > 10) {
                ...
                if (grid.scrollable)
                    grid.$tbody.parent()
                        ...
                        .css('width', gridWidth + (isRtl ? columnStart - e.pageX : e.pageX - columnStart));
        ...
        function init(e) {
            ...
            cols.each(function (i, col) {
                ...
                .css({
                    right: isRtl ? left - indicatorWidth : undefined,
                    left: isRtl ? undefined : left - indicatorWidth,

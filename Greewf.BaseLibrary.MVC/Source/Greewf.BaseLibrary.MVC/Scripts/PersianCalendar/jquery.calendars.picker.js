...
(function ($) { // Hide scope, no $ conflict
    ...
    $.extend(CalendarsPicker.prototype, {
        ...
        defaultRenderer: {
            ...
            picker: '<div class="t-widget t-calendar t-popup t-datepicker-calendar">' +
		'<div class="calendars-nav t-header">{link:prev}{link:today}{link:next}</div>{months}' +
		'{popup:start}<div class="calendars-ctrl t-header">{link:clear}{link:close}</div>{popup:end}' +
		'<div class="calendars-clear-fix"></div></div>',
            ...
            month: '<div class="calendars-month"><div>{monthHeader}</div>' +
		'<table><thead>{weekHeader}</thead><tbody>{weeks}</tbody></table></div>',
            ...
            selectedClass: 't-link t-state-selected t-state-focus',
            // Class for highlighted dates
            highlightedClass: 't-state-hover',
            // Class for today
            todayClass: 'calendars-today',
            // Class for days from other months
            otherMonthClass: 'calendars-other-month',
            // Class for days on weekends
            weekendClass: 't-state-selected',
            // Class prefix for commands
            commandClass: 'calendars-cmd',
            // Extra class(es) for commands that are buttons
            commandButtonClass: ' t-link',
            // Extra class(es) for commands that are links
            commandLinkClass: 't-link',
            ...
            if (inst) {
                ...
                if (inst.inline) {
                    ...
                    if (!inst.div) {
						...
						}).css('z-index', '60000')./*added by moravej*/

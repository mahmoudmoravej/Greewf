...
ApplyTemplate -TemplateFileName "ViewModelMetaData" -Project:$WebProject -OutputPath:$MetaDataFolder -OutputFilePostName:'MetaData' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace -DefaultImportingNamespaces:$DefaultImportingNamespaces
ApplyTemplate -TemplateFileName "GridViewModel" -Project:$WebProject -OutputPath:$GridFolder -OutputFilePostName:'GridViewModel' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace -DefaultImportingNamespaces:$DefaultImportingNamespaces
ApplyTemplate -TemplateFileName "SearchCriteria" -Project:$WebProject -OutputPath:$SearchCriteria -OutputFilePostName:'SearchCriteria' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace -DefaultImportingNamespaces:$DefaultImportingNamespaces
...
#non-grid related
$ViewType = $ViewModel
ApplyTemplate -TemplateFileName "_CreateOrEdit" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'_CreateOrEdit' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile
ApplyTemplate -TemplateFileName "_Details" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'_Details' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile
ApplyTemplate -TemplateFileName "Create" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'Create' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile
ApplyTemplate -TemplateFileName "Edit" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'Edit' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile
ApplyTemplate -TemplateFileName "Delete" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'Delete' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile
ApplyTemplate -TemplateFileName "Details" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'Details' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile

#search 
$ViewType = $SearchViewModel
ApplyTemplate -TemplateFileName "_SearchCriteria" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'_SearchCriteria' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile
ApplyTemplate -TemplateFileName "Search" -Project:$WebProject -OutputPath:$ViewPath -OutputFilePostName:'Search' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace  -DefaultImportingNamespaces:$DefaultImportingNamespaces -IgnoreModelNameInFile
...
ApplyTemplate -TemplateFileName "IRepository" -Project:$RepositoryProject -OutputPath:$RepositoryInterfaceFolder -OutputFilePostName:'Repository' -OutputFilePreName:'I' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace -DefaultImportingNamespaces:$DefaultImportingNamespaces

#4-2: Repository Interface
Write-Host "Scaffolding Repository Class..." -ForegroundColor blue
ApplyTemplate -TemplateFileName "Repository" -Project:$RepositoryProject -OutputPath:$RepositoryFolder -OutputFilePostName:'Repository' -OutputFilePreName:'' -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace -DefaultImportingNamespaces:$DefaultImportingNamespaces
...
if($e)
{
	...
	$o = ApplyTemplate -TemplateFileName "PermissionLimitters" -Project:$RepositoryProject  -IsOutputText -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace -DefaultImportingNamespaces:$DefaultImportingNamespaces
...
if($e)
{
	...
	$blocStartPoint = $e.GetStartPoint(16).CreateEditPoint()#16 = EnvDTE.vsCMPart.vsCMPartBody
	$blocEndPoint = $e.GetEndPoint(16).CreateEditPoint()	#16 = EnvDTE.vsCMPart.vsCMPartBody
	$o = ApplyTemplate -TemplateFileName "PermissionAttribute" -Project:$RepositoryProject  -IsOutputText -RepositoryProject:$RepositoryProject -SubRepositoryNameSpace:'Repositories' -WebProject:$WebProject -SubViewModelNameSpace:$SubViewModelNameSpace -SubViewModelMetaDataNameSpace:'Models.MetaData' -ControllerSubNamespace:$ControllerSubNamespace -DefaultImportingNamespaces:$DefaultImportingNamespaces
